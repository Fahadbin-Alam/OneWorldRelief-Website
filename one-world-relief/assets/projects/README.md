...
- `case-009/` contains metadata-stripped `thumbnail`, `main`, and `proof` JPEGs documenting the completed donation of 20 ceiling fans to a newly built mosque in Bangladesh. The public case page uses only the approved field photos; private correspondence with a phone number remains unpublished.
